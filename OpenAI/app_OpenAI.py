...
# End of analysis block
    ...
    with tab4:
        ...
        model_option = st.text_input(
            ...
            value=os.getenv("LM_STUDIO_MODEL", "marcoroni-neural-chat-7b-v2_gsm8k_merged"),
            help="Enter a model currently loaded in LM Studio (/v1/models).",
        )
                ...
                if ai_id1 == ai_id2:
                    ...
                    try:
                        ...
                        with st.spinner("⏳ Generating report data..."):
                            ...
                            if isinstance(report_html, str) and "No data found" in report_html:
                                ...
                                if analysis and not analysis.startswith("Error"):
                                    ...
                                    st.error(f"❌ {analysis}")
                                    st.info(
                                        "💡 Ensure LM Studio server is running at "
                        ...
                        st.info(
                            ...
                            "Verify endpoint with: GET /v1/models"
                        )
            else:
